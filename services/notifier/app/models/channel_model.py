"""
NotificationChannel model for notifier service.

This mirrors the NotificationChannel model from Central but is defined here
to keep notifier independent. Both services connect to the same
PostgreSQL database and share the notifications.notificationchannel table.
"""
