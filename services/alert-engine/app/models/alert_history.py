"""
AlertHistory model for alert-engine service.
...
class AlertHistory(SQLModel, table=True):
    ...
    Status values:
    - triggered: Normal alert that fired
    - silenced: Alert that matched a silence rule and was suppressed
    ...
    status: str = Field(
        ...
        description="Alert status: triggered, silenced, acknowledged",
    )
